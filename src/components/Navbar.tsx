          ...
          {({ open }) => (
            <>
                <Disclosure.Button
                  ...
                  className="px-2 py-1 text-gray-500 rounded-md lg:hidden hover:text-pancho-500 focus:text-pancho-500 focus:bg-pancho-100 focus:outline-none dark:text-gray-300 dark:focus:bg-trueGray-700">
                  <svg
