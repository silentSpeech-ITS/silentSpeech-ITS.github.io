...
export function Video({ videoId }: Readonly<VideoProps>) {
  ...
  return (
    <Container>
      <div className={`relative w-full h-[500px] max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl bg-pancho-300 cursor-pointer bg-[url("/extra_assets/video/silentspeech-video-thumbnail.jpg")] bg-center from-purple-400 to-pancho-700`}>
        {!playVideo && (
          <button
